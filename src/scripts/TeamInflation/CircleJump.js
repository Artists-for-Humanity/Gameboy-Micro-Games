export default class CircleJump extends Phaser.Scene {
  ...
  preload() {
    this.load.image(
      this.load.image(
        "background",
        new URL("./assets/CircleJump/circlebackground.png", import.meta.url)
          .href
      )
    );
    ...
    this.load.image(
      this.load.image(
        "lose",
        new URL("./assets/CircleJump/loser.png", import.meta.url).href
      )
    );
    this.load.image(
      this.load.image(
        "win",
        new URL("./assets/CircleJump/winner.png", import.meta.url).href
      )
    );
    ...
    this.load.spritesheet(
      "ball",
      new URL("./assets/CircleJump/ballSpriteSheet.png", import.meta.url).href,
      {
        frameWidth: 19,
        frameHeight: 19,
      }
    ...
    this.load.spritesheet(
      "diamonds",
      new URL("./assets/CircleJump/diamond.png", import.meta.url).href,
      {
        frameWidth: 16,
        frameHeight: 16,
      }
  ...
  create() {
    ...
    this.startGameDelay = this.time.delayedCall(
      2300,
      this.startGame,
      null,
      this
