...
export default class Lowest extends Phaser.Scene {
  ...
  preload() {
    this.load.image(
      "TI_1background",
      new URL("./assets/Lowest/NGbackground.png", import.meta.url).href
    );
    this.load.image(
      "TI_1cursorimage",
      new URL("./assets/Lowest/cursorimage.png", import.meta.url).href
    );
    this.load.image(
      "TI_1lose",
      new URL("./assets/Lowest/xmark.png", import.meta.url).href
    );
    this.load.image(
      "TI_1win",
      new URL("./assets/Lowest/checkmark.png", import.meta.url).href
    );

    this.load.spritesheet(
      "TI_1frames",
      new URL("./assets/Lowest/frames.png", import.meta.url).href,
      {
        frameWidth: 1368 / 3,
        frameHeight: 329,
      }
    ...
    this.load.spritesheet(
      "TI_1numbers",
      new URL("./assets/Lowest/numbers.png", import.meta.url).href,
      {
        frameWidth: 313,
        frameHeight: 350,
      }
    ...
    this.load.spritesheet(
      "TI_1operations",
      new URL("./assets/Lowest/operations.png", import.meta.url).href,
      {
        frameWidth: 1408 / 4,
        frameHeight: 294,
      }
  ...
  create() {
    ...
    this.fillBox(1, X * 0.75, Y * 0.2);
    this.fillBox(2, X * 0.5, Y * 0.5);
    this.fillBox(3, X * 0.25, Y * 0.8);
    this.fillBox(4, X * 0.75, Y * 0.8);
  ...
  fillBox(i, x, y) {
    ...
    if (this.opcode[i] !== 0) {
      placement = -1084 / 1.75;
      // add an operator
      this.equations[i].add(
        this.add.image(0, 0, "TI_1operations", this.opcode[i] - 1)
      );
    ...
    if (this.opcode[i] !== 0) {
      ...
      switch (smallcheck) {
        case 1:
          this.box[i].setScale(0.8, 0.5);
          break;
        case 2:
          this.box[i].setScale(0.6, 0.5);
          break;
        default:
          break;
      }
