...
export default class CutScreen extends Phaser.Scene {
  ...
  preload() {
    this.load.spritesheet(
      "gba",
      new URL("assets/gba.png", import.meta.url).href,
      { frameWidth: 252, frameHeight: 162 }
    );
    this.load.spritesheet(
      "loss",
      new URL("assets/loss_cat.png", import.meta.url).href,
      { frameWidth: 419, frameHeight: 162 }
    );
    this.load.spritesheet(
      "win",
      new URL("assets/win_cat.png", import.meta.url).href,
      { frameWidth: 419, frameHeight: 162 }
    );
    this.load.spritesheet(
      "numbers",
    ...
    this.load.image(
      "gba_socket",
      new URL("assets/gba_socket.png", import.meta.url).href
    );
    this.load.image(
      "num_plate",
      new URL("assets/num_plate.png", import.meta.url).href
    );
    this.load.image(
      "l_door",
      new URL("assets/l_door.png", import.meta.url).href
    );
    this.load.image(
      "r_door",
      new URL("assets/r_door.png", import.meta.url).href
    );

    this.load.image(
      "toss!",
      new URL("../textPrompts/toss.png", import.meta.url).href
    );
    this.load.image(
      "catch!",
      new URL("../textPrompts/Catch_Text.png", import.meta.url).href
    );
    this.load.image(
      "pour!",
      new URL("../textPrompts/pourtext.png", import.meta.url).href
    );
    this.load.image(
      "pull!",
      new URL("../textPrompts/pulltext.png", import.meta.url).href
    );
    this.load.image(
      "sort!",
      new URL("../textPrompts/sort.png", import.meta.url).href
    );
    this.load.image(
      "swat!",
      new URL("../textPrompts/swatText.png", import.meta.url).href
    );
    this.load.image(
      "swat!",
      new URL("../textPrompts/swatText.png", import.meta.url).href
    ...
    this.load.image(
      "munch!",
      new URL("../textPrompts/munch.png", import.meta.url).href
    );
    this.load.image(
      "jump!",
      new URL("../textPrompts/Jump.png", import.meta.url).href
    );
    this.load.image(
      "pick the lowest!",
      new URL("../textPrompts/lowest.png", import.meta.url).href
    );
    this.load.image(
      "cheese it!",
      new URL("../textPrompts/cheeseit.png", import.meta.url).href
    );
    this.load.image(
      "memorize!",
      new URL("../textPrompts/memorize.png", import.meta.url).href
    );
    this.load.image(
      "slap it!",
      new URL("../textPrompts/slapit.png", import.meta.url).href
    );
    this.load.image(
      "mix!",
      new URL("../textPrompts/mix.png", import.meta.url).href
    );
    this.load.image(
      "pump!",
      new URL("../textPrompts/pump.png", import.meta.url).href
    );
    this.load.image(
      "dodge!",
      new URL("../textPrompts/dodge.png", import.meta.url).href
    );
    this.load.image(
      "avoid!",
      new URL("../textPrompts/avoid.png", import.meta.url).href
    );
    this.load.image(
      "add!",
      new URL("../textPrompts/add.png", import.meta.url).href
    );
  }
  ...
  closecon() {
    ...
    if (this.roundNumber > 0) {
      ...
      if (this.scene.isActive("MainMenu")) this.scene.remove("MainMenu");
    }
    this.nextGame();
  }
  nextGame() {
    ...
    if (this.currentScene !== "GameOver") this.scene.run("Timer");
    else this.scene.remove("Timer");
    this.scene.run(this.currentScene);
    // console.log(this.currentScene + " should be running...");
    this.roundNumber++;
    //Initial timeout for win/lose anim
    setTimeout(() => {
      if (this.currentScene !== "GameOver") this.textPrompt.setVisible(true);
      setTimeout(() => {
